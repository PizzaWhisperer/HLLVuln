...
\documentclass[sigconf, anonymous, dvipsnames]{acmart} %dvipsnames for old/new macros

\fancyhf{} % Remove fancy page headers 
\fancyhead[C]{Anonymous submission \#147 to ACM CCS 2021} % TODO: replace 9999 with your paper number
\fancyfoot[C]{\thepage}
