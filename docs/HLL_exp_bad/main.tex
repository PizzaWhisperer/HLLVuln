...
\todo{Add a couple of paragraphs to relate all this back to the initial attack scenarios, e.g. packet flows. May need to look at internals of some of those papers to see where flex in inputs will come from. }
