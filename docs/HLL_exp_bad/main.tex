...
\begin{table*}[tb!]
\small\centering
\caption{Attack results for a classic HLL implementation, averaged over 50 iterations.}
\medskip
     \makebox[\linewidth]{
...
\begin{table*}[tb!]
\small\centering
\caption{Attack results for a classic HLL implementation, averaged over 50 iterations, in the setting of~\cite{hllvuln}.}
\medskip
     \makebox[\linewidth]{
\begin{tabular}{| m{11em} | m{3.4em} | m{4.8em} | m{4.1em} | m{4.1em} | m{4.1em} | m{4em} |}
    \hline
