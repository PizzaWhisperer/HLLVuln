...
\begin{table*}[tb!]
\caption{Comparison of attack results in the S1 adversarial scenario, in the setting of~\cite{hllvuln}.}
\begin{center}
...
The results are averaged over 50 iterations and reported in Table~\ref{table:tab3}.
Similarly to the case for classic HLL, our empirical results match closely with our theoretical analysis.

\begin{table*}[tb!]
\begin{center}
\caption{Attack results for HLL in Redis, scenario S2, averaged over 50 iterations.}\label{table:tab3}
