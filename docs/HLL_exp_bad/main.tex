...
\subsection{Further analysis of Flexswitches}\label{sec:flexswitch}
...
\subsection{Proof of Theorem 8.1}\label{sec:proof} %ridiculous, but had to hard-code this reference
...
\subsection{Breaking HLL-UHF}\label{sec:UHF}
