...
For example, our microbenchmarks created on an Intel i7 CPU show that SipHash-2-4 is as fast as the 128-bit version of MurmurHash3 and only slightly slower than the original 32-bit version.
