...
/* PFATTACK history */
#define PFATTACK_History NULL

/* PFATTACK tips */
#define PFATTACK_tips NULL

/* PFATTACK argument table */
struct redisCommandArg PFATTACK_Args[] = {
{"key",ARG_TYPE_KEY,0,NULL,NULL,NULL,CMD_ARG_NONE},
{0}
};
...
{"pfattack","Attacks the specified HyperLogLog.","O(1) to add every element.","2.8.9",CMD_DOC_NONE,NULL,NULL,COMMAND_GROUP_HYPERLOGLOG,PFATTACK_History,PFATTACK_tips,pfattackCommand,-2,CMD_WRITE|CMD_DENYOOM|CMD_FAST,ACL_CATEGORY_HYPERLOGLOG,{{CMD_KEY_RW|CMD_KEY_INSERT,KSPEC_BS_INDEX,.bs.index={1},KSPEC_FK_RANGE,.fk.range={0,1,0}}},.args=PFATTACK_Args},
